...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :family "Segoe UI" :height 130)
  (set-face-attribute 'mode-line nil :family "Segoe UI" :height 130)
  (set-face-attribute 'mode-line-inactive nil :family "Segoe UI" :height 130)
#+END_SRC
