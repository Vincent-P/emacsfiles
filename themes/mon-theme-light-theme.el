...
(let* (
  ...
  (custom-theme-set-faces
   ...
   ;; --- Custom faces
   `(my-evil-tag-face:normal ((t (:inherit mode-line :foreground ,fg_base))))
   `(my-evil-tag-face:emacs ((t (:inherit my-evil-tag-face:normal))))
   `(my-evil-tag-face:insert ((t (:inherit my-evil-tag-face:normal))))
   `(my-evil-tag-face:replace ((t (:inherit my-evil-tag-face:normal))))
   `(my-evil-tag-face:motion ((t (:inherit my-evil-tag-face:normal))))
   `(my-evil-tag-face:visual ((t (:inherit my-evil-tag-face:normal))))
   `(my-evil-tag-face:operator ((t (:inherit my-evil-tag-face:normal))))
